  ...
  <div class="userusersaccount">
    ...
    <div class="body">
      <div class="left">
        ...
        <el-button @click="changePhone=true" type="primary" style="margin-top: 20px; width: 150px"
          >更换手机号</el-button
        >
      </div>
      <div class="right">
    ...
    >
      <div class="restMode">
        <p class="title">重置密码成功</p>
        <p class="newPwd">新密码为:<span ref="newPwd">{{resPwd}}</span><span @click.stop="copyPwd">复制</span></p>
        <p class="message">密码通过手机号短信发送,请提醒用户留意短信</p>
        <div class="resBtn">
          <el-button @click="resetPwd=false" style="width:200px;margin-top:20px;" type="primary">确定</el-button>
        </div>
      </div>
    </el-dialog>
    <!-- 更换手机号 -->
    <el-dialog :visible.sync="changePhone"
      title="更换手机号"
      width="700px"
      top="25vh">
      <div class="changePhone">
        ...
        <div class="changePhone_foot">
          <el-button @click="changePhones" style="width:150px;" type="primary">确认</el-button>
          <el-button @click="changePhone=false" style="width:150px;">取消</el-button>
        </div>
      </div>
      </el-dialog>
  </div>
