<template>
  ...
  <div class="myfollow">
    <div class="list_wrap">
      <div class="list_nav">
        <span @click="listenChooseNav('all')" :class="{'cur':chooseNav=='all'}">全部关注</span>
        <span @click="listenChooseNav('country')" :class="{'cur':chooseNav=='country'}">国家</span>
        <span @click="listenChooseNav('people')" :class="{'cur':chooseNav=='people'}">人物</span>
        <span @click="listenChooseNav('media')" :class="{'cur':chooseNav=='media'}">媒体</span>
      </div>
      <div class="gjlb">
